...
@Component({
  selector: 'app-msg-sended',
  templateUrl: './msg-sended.component.html',
  styleUrls: ['./msg-sended.component.css']
})
export class MsgSendedComponent implements OnInit {
  ...
  getMessages(token: any, page: any, limit: any){
    this._messageService.getEmitMessages(token, page, limit).subscribe((res: any)=>{
